...
extension Material: ERPCodeRepresentable {
...
extension Material: Titleable {
    ...
    public var title: String {
        switch self {
        case .EIK: String("EIK")
        case .EIKBODEM: String("EIKBODEM")
        case .EIKFRANS: String("EIKFRANS")
        case .EIKROOD: String("EIKROOD")
        case .EIKRUSTIEK: String("EIKRUSTIEK")
        case .DEN: String("DEN")
        case .FINEER: String("FINEER")
        case .KUNSTSTOF: String("KUNSTSTOF")
        case .METAAL: String("METAAL")
        case .PINE: String("PINE")
        case .PINMARITIME: String("PIN MARITIME")
        case .PLAATMATERIAAL: String("PLAATMATER")
        case .POPULIER: String("POPULIER")
        case .PRINT: String("PRINT")
        case .TROPISCH: String("TROPISCH")
        case .ZINK: String("ZINK")
        case .INHEEMS: String("INHEEMS")
        case .LANGLOPEND: String("LANGLOPEND")
        case .THANA: String("THANA")
        }
    }
}
